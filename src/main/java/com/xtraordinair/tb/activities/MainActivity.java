...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get Material Design Toolbar cardview_result_layout from XML
        //set toolbar for MainActivity
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        //Get DrawerLayout from XML
        //Initialize Toggle
        //setDrawer to toggle
        //Keep Drawer synced
    ...
    public void onBackPressed() {
        ...
        //Get Drawer cardview_result_layout
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        //TODO: Add actions on navbar selected items
        if (id == R.id.feat_beer) {

        } else if (id == R.id.feat_brewery) {

        } else if (id == R.id.rand_beer) {

        } else if (id == R.id.rand_brewery) {
