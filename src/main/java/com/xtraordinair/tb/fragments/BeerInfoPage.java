...
public class BeerInfoPage extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (mScrollView == null){
            ...
            //ScrollView (Parent)
            mScrollView = (ScrollView) inflater.inflate(R.layout.infopage_beer_layout, container, false);
            mScrollView.setSmoothScrollingEnabled(true);

            TextView beerNameTextView = (TextView) mScrollView.findViewById(R.id.name_content_textview);
            if(mBeer.getName() != null){
                beerNameTextView.setText(mBeer.getName());
            }
            TextView assocBreweryTextView = (TextView) mScrollView.findViewById(R.id.assoc_brewery_name_content_textview);
            if(mBeer.getBreweryName() != null){
                assocBreweryTextView.setText(mBeer.getBreweryName());
            }

            //Label image
            ImageView labelImageView = (ImageView) mScrollView.findViewById(R.id.label_image_imageview);
            labelImageView.setImageBitmap(mBeer.getBitmapLarge());

            //ABV content
            TextView abvTitleTextView = (TextView) mScrollView.findViewById(R.id.abv_title_textview);
            TextView abvContentTextView = (TextView) mScrollView.findViewById(R.id.abv_content_textview);
            ...
            //IBU content
            TextView ibuTitleTextView = (TextView) mScrollView.findViewById(R.id.ibu_title_textview);
            TextView ibuContentTextView = (TextView) mScrollView.findViewById(R.id.ibu_content_textview);
            ...
            //SRM content
            TextView srmTitleTextView = (TextView) mScrollView.findViewById(R.id.srm_title_textview);
            TextView srmContentTextView = (TextView) mScrollView.findViewById(R.id.srm_content_textview);
            ...
            //OG content
            TextView ogTitleTextView = (TextView) mScrollView.findViewById(R.id.og_title_textview);
            TextView ogContentTextView = (TextView) mScrollView.findViewById(R.id.og_content_textview);
            ...
            TextView descriptionTitleTextView = (TextView) mScrollView.findViewById(R.id.description_title_textview);
            TextView descriptionContentTextView = (TextView) mScrollView.findViewById(R.id.description_content_textview);
